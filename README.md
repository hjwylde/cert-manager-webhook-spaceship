...
```bash
kubectl apply -f https://raw.githubusercontent.com/hjwylde/cert-manager-webhook-spaceship/v0.1.3/config/manifest.yaml
```
...
kind: Kustomization
resources:
  - github.com/hjwylde/cert-manager-webhook-spaceship/config?ref=v0.1.3
```
